...
getData<Quiz>(`${QUIZ_URL}/start`)
  ...
  .then((quiz) => {
    ...
    let activeAnswer = 0;
    const answers: MaybeAnswer[] = questions.map((question) => ({
      ...question,
    ...
    function modalConfirm() {
      ...
      if (showModal === 'finish') {
        ...
        postData(`${QUIZ_URL}/finish`, results)
